...
public class GuestSecondDuplicateTest extends UserBaseTest{
    ...
    @Test(priority = 1)
    public void setPageObjectsSecond()
    {
    ...
    @Test(priority = 2, dependsOnMethods = "setPageObjectsSecond")
    public void Guest_Login_and_Set_TPASecond()
    {
        mobileDriver = getDriver();
