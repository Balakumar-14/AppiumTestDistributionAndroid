...
public class GuestFirstDuplicateTest extends UserBaseTest{
    ...
    @Test(priority = 1)
    public void setPageObjectsFirst()
    {
    ...
    @Test(priority = 2, dependsOnMethods = "setPageObjectsFirst")
    public void Guest_Login_and_Set_TPAFirst()
    {
        mobileDriver = getDriver();
